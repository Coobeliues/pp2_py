...
class Snake:
    def __init__(self, color, dx=0, dy=1, elements=None):
        if elements is None:
            elements = [[random.randint(100, 690), random.randint(100, 490)]]
    ...
    def lose(self, lvl1, lvl2, lvl3):
        ...
        for i in range(len(a)):
            for j in range(len(a[i])):
                if a[i][j] == "#" and i * 10 - 10 <= self.elements[0][0] <= i * 10 + 10 and j * 10 - 10 <= \
                        self.elements[0][1] <= j * 10 + 10:
                    return False
...
def op(lvl1, lvl2, lvl3):
    ...
    while running:
        ...
        if not snake.lose(lvl1, lvl2, lvl3):
            time.sleep(1)
            running = False
        x.write("1" + "\n" + str(snake.dx) + " " + str(snake.dy) + "\n" + str(lvl1) + " " + str(lvl2) + " " + str(
            lvl3) + " " + "\n")
        x.write(str(snake.elements))
        x.close()
...
def tp(lvl1, lvl2, lvl3):
    ...
    while running:
        ...
        if not snake2.lose(lvl1, lvl2, lvl3):
            time.sleep(1)
            running = False
        x.write(str(snake.dx) + " " + str(snake.dy) + "\n" + str(lvl1) + " " + str(lvl2) + " " + str(lvl3) + " " + "\n")
        x.write(str(snake.elements))
