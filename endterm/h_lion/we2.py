...
collect = pygame.mixer.Sound('collect2.wav')
complete = pygame.mixer.Sound('complete2.wav')
loose = pygame.mixer.Sound('loosing2.wav')
oshibka = pygame.mixer.Sound('oshibka2.wav')
...
class Game(object):
    ...
    def display_frame(self, screen):
        ...
        screen.fill(WHITE)
        render_score = font_score.render(f'SCORE: {self.score}', True, pygame.Color('orange'))
